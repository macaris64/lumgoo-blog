export const portfolio = {
  ...
  experience: [
    {
      ...
      current: true,
      description:
        "Contributing to Udemy’s AI-driven transformation by developing large-scale platforms that enhance learning and teaching experiences. Involved in both the Assessment Platform and Instructor Insights teams, focusing on building intelligent, scalable, and data-driven systems.",
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        "Contributed to BluTV’s digital transformation journey from a growing startup into a large-scale media and entertainment platform. Worked on core backend systems that powered subscription, authentication, and video-on-demand services for millions of users.",
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        "Worked as a Web Developer at eloop Digital Solution, a company providing cloud-based semantic integration software for e-commerce and e-conversion, helping SMEs overcome challenges in accessing global marketing. Contributed to B2B and B2C web projects with a focus on usability and performance.",
      achievements: [
      ...
      technologies: ["HTML", "CSS", "JavaScript", "PHP", "MySQL", "REST APIs"],
    },
  ],
  ...
  education: [
    {
      ...
      gpa: "2.99/4.0",
      description:
        "Comprehensive education in computer science fundamentals, software engineering, and system design.",
      achievements: ["President of IT Society"],
    },
  ],
  ...
  volunteer: [
    ...
    },
    {
      ...
      current: false,
      description: "",
      activities: ["BİLMÖK '17", "Coding workshops"],
    },
    {
      ...
      current: false,
      description: "",
      activities: ["SAÜ Genç Yeşilay", "https://www.instagram.com/saugencyesilay/"],
    },
  ],
};
